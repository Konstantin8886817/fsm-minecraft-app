import createFSMLibrary from './fsmLib'
    ...
    describe('machineConfig param unit tests', () => {
      describe('when machineConfig provided', () => {
        it('should not throw an exception', () => {
          expect(() => {
            createFSMLibrary({initialState: 'one'})
          }).not.toThrow()
        })
      })
  ...
  describe('doAction', () => {
    describe('when configuration provided', () => {
      ...
      beforeEach(() => {
        ...
        actionMock = jest.fn().mockImplementationOnce(() => {
          return Promise.resolve(10)
        })

        fsm = createFSMLibrary({
          initialState: 'one',
      ...
      describe('when doAction called with a known action - inc', () => {
        ...
        describe('onActionEnter hook', () => {
          it('should call global onActionEnter', () => {
            ...
            expect(onActionEnterGlobalMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
          ...
          it('should call state onActionEnter', () => {
            ...
            expect(onActionEnterStateMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
          ...
          it('should call action onActionEnter', () => {
            ...
            expect(onActionEnterActionMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
        ...
        describe('onActionExit hook', () => {
          it('should call global onActionExit', () => {
            ...
            expect(onActionExitGlobalMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
          ...
          it('should call state onActionExit', () => {
            ...
            expect(onActionExitStateMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
          ...
          it('should call action onActionExit', () => {
            ...
            expect(onActionExitActionMock).toHaveBeenCalledWith(
              'inc',
              'one',
              'two',
            )
